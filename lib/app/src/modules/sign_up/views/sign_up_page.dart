                              ...
                              child: Observer(
                                builder: (_) {
                                  return TextFieldWithValidationWidget(
                                    ...
                                    placeholder: FlutterI18n.translate(
                                        context, 'telaCadastroUsuario.nome'),
                                    onChanged: (newName) {
                              ...
                              child: Observer(
                                builder: (_) {
                                  return TextFieldWithValidationWidget(
                                    ...
                                    placeholder: FlutterI18n.translate(
                                        context, 'telaCadastroUsuario.email'),
                                    onChanged: (newEmail) {
                              ...
                              child: Observer(
                                builder: (_) {
                                  return TextFieldWithValidationWidget(
                                    ...
                                    placeholder: FlutterI18n.translate(
                                        context, 'telaCadastroUsuario.senha'),
